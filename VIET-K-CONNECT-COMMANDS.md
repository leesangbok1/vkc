...
레벨 시스템:
- Lv.1-10: 초보 (50 XP/레벨)
- Lv.11-20: 중수 (100 XP/레벨)
- Lv.21-30: 고수 (200 XP/레벨)
- Lv.30+: 마스터 (500 XP/레벨)

뱃지 카테고리:
- 활동 뱃지: 첫 질문, 답변 마스터 등
- 신뢰 뱃지: 한국 1/3/5년차, 비자 인증
- 전문 뱃지: 카테고리별 전문가

표시: "Lv.23 🎖️ Nguyen Van A (한국 3년차 | E-7 삼성전자)"
```
...
1. 인앱 실시간 알림 (웹소켓)
2. 브라우저 푸시 (PWA)
3. Facebook 메신저 (MVP는 수동)
4. 이메일 (SendGrid 무료)

**24시간 타이머**
- 목적: 답변 보장으로 신뢰 구축
- 시각화: 색상 변화 (녹색→노란색→빨간색)
- 자동 재매칭: 무응답시 추가 3명
